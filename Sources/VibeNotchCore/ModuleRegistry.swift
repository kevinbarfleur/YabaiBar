...
public final class ModuleRegistry: ObservableObject {
    @Published public private(set) var modules: [any VibeNotchModule] = []
    ...
    private enum DefaultsKey {
        static let enabledModules = "VibeNotch.enabledModuleIDs"
        static let widgetOrder = "VibeNotch.widgetOrder"
        static let leadingSlotOrder = "VibeNotch.leadingSlotOrder"
        static let trailingSlotOrder = "VibeNotch.trailingSlotOrder"
        static let disabledSlotIDs = "VibeNotch.disabledSlotIDs"
        static let activeStatusBarModule = "VibeNotch.activeStatusBarModuleID"
    }
    ...
    public func register(_ module: any VibeNotchModule) {
    ...
    public var enabledModules: [any VibeNotchModule] {
        modules.filter { enabledModuleIDs.contains($0.identifier.rawValue) }
    }

    public var activeStatusBarModule: (any VibeNotchModule)? {
    ...
    private func orderedSlots(
        ...
        side: SlotSide,
        order: [String],
        slotProvider: (any VibeNotchModule, String) -> NotchSlotContent?
    ) -> [NotchSlotContent] {
